...
class FeatureViewer(zoomableVideo.ZoomableVideo):
    def __init__(
        ...
        self.feature_dicts["GM"] = {"show": self.show__glottal_midline, "opacity": self.set_glottal_midline_opacity}
        ...
        self.feature_dicts["GO"] = {"show": self.show__glottal_outline, "opacity": self.set_glottal_outline_opacity}
        ...
        self.feature_dicts["GS"] = {"show": self.show__glottal_segmentation, "opacity": self.set_glottal_segmentation_opacity}
        ...
        self.feature_dicts["VS"] = {"show": self.show__vocalfold_segmentation, "opacity": self.set_vocalfold_opacity}
    ...
    def show__vocalfold_segmentation(self, show: bool):
        self._show_vfs = show

    def show__glottal_outline(self, show: bool):
        self._show_go = show

    def show__glottal_segmentation(self, show: bool):
        self._show_gs = show

    def show__glottal_midline(self, show: bool):
        self._show_gm = show
